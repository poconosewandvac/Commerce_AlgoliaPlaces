...
if (!createObject('modNamespace',array(
    'name' => 'commerce_algoliaplaces',
    'path' => $componentPath.'/core/components/commerce_algoliaplaces/',
    'assets_path' => $componentPath.'/assets/components/commerce_algoliaplaces/',
),'name', false)) {
    echo "Error creating namespace commerce_algoliaplaces.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_algoliaplaces.core_path',
    'value' => $componentPath.'/core/components/commerce_algoliaplaces/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_algoliaplaces',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_algoliaplaces.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_algoliaplaces.assets_path',
    'value' => $componentPath.'/assets/components/commerce_algoliaplaces/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_algoliaplaces',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_algoliaplaces.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_algoliaplaces/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_algoliaplaces.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_algoliaplaces',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_algoliaplaces.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_algoliaplaces.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_algoliaplaces',
        'area' => $opts['area'],
        ...
        echo "Error creating commerce_algoliaplaces.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_algoliaplaces/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_algoliaplaces/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'PoconoSewVac\\AlgoliaPlaces\\Modules\\', $modulePath);
